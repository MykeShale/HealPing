          ...
          <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            <div className="flex flex-1 items-center">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-gray-700">Dr. {profile?.full_name?.split(" ")[0]}</span>
              </div>
            </div>
                ...
                <DropdownMenuContent className="w-56" align="end" forceMount>
                  <DropdownMenuLabel className="font-normal">
                    <div className="flex flex-col space-y-1">
                      <p className="text-sm font-medium leading-none">Dr. {profile?.full_name}</p>
                      <p className="text-xs leading-none text-muted-foreground">Healthcare Provider</p>
                    </div>
                  </DropdownMenuLabel>
                  <DropdownMenuSeparator />
